        ...
        <form onSubmit={onSubmit} className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    {errors.guardianPhoneNumber && <span className="text-red-400 text-xs">{errors.guardianPhoneNumber.message}</span>}
                </div>
                <div className="flex flex-col gap-2">
                    ...
                    <div className="w-full cut-edge-all-sm bg-gradient-to-t from-[#FFB6C1] to-[#121212] p-[2px]">
                        <input 
                            ...
                            className={`text-sm bg-black w-full h-full p-1 rounded-sm ${errors.guardianRelationship ? 'border-red-500' : ''}`}
                    ...
                    {errors.guardianRelationship && <span className="text-red-400 text-xs">{errors.guardianRelationship.message}</span>}
                </div>
            </div>
