...
export interface ButtonRpkmProps
...
export default function ButtonRpkm({
  ...
  const buttonClasses = cn(
    ...
    // Additional classes
    "text-decoration-none focus:outline-2 focus:outline-offset-2 focus:outline-white/30",
    variant === "stroke" && "bg-contain bg-center bg-no-repeat",
  ...
  const getSvgBorder = (): string => {
    ...
    const { width, height } = dimensions[
      widthClass as keyof typeof dimensions
    ] || { width: 176, height: 48 };
    const cutSize = 20;
